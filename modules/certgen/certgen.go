// From: https://golang.org/src/crypto/tls/generate_cert.go?m=text
package certgen
...
var (
	...
	ecdsaCurve string        = "P256"               // ECDSA curve to use to generate a key. Valid values are P224, P256, P384, P521")
)
...
func Generate(phost string, pvalidFrom string, pvalidFor time.Duration, pisCA bool, prsaBits int, pecdsaCurve string) {
